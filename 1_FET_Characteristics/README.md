...
### Id-Vgs Transfer Characteristic — NMOS (Log Scale)

![NMOS Id-Vgs Log Scale Transfer Curve](./images/nmos_id_vgs_log.png)

*Expected: S-curve on logarithmic Id axis. Off-state leakage floor (~fA–pA range), subthreshold slope extraction tangent line, threshold voltage inflection point near 0.25–0.30 V, strong inversion linear increase above Vth.*

---

### Id-Vgs Transfer Characteristic — NMOS (Linear Scale)

![NMOS Id-Vgs Linear Scale Transfer Curve](./images/nmos_id_vgs_linear.png)

*Expected: Quadratic-to-linear transition above Vth. Transconductance gm = dId/dVgs can be numerically differentiated from this curve.*

---

### Id-Vds Output Characteristics — PMOS (Family of Curves)

![PMOS Id-Vds Output Characteristics](./images/pmos_id_vds.png)

*Expected: Mirrored topology to NMOS family. Id plotted as |Id| for readability. Note lower saturation current than NMOS counterpart due to reduced hole mobility (u0_P / u0_N ≈ 0.78).*

---

### Id-Vgs Transfer Characteristic — PMOS (Log Scale)

![PMOS Id-Vgs Log Scale Transfer Curve](./images/pmos_id_vgs_log.png)

*Expected: Subthreshold swing, GIDL signature at low Vgs (high Vsd), distinct threshold voltage relative to NMOS due to PMOS gate work function difference (phig = 4.9278 eV).*

---

## Extracted Parameters Summary Table

> Populate after simulation runs.

| Parameter | NMOS (sim) | PMOS (sim) | Unit |
|---|---|---|---|
| Threshold Voltage Vth | — | — | V |
| Subthreshold Slope SS | — | — | mV/dec |
| DIBL | — | — | mV/V |
| Peak Transconductance gm_max | — | — | mS |
| Ion (Vgs=Vds=0.7V, nfin=14) | — | — | µA |
| Ioff (Vgs=0V, Vds=0.7V, nfin=14) | — | — | pA |
| Ion/Ioff Ratio | — | — | — |
